...
const config = {
  title: 'Infra Synthesis',
  tagline: 'Kubernetes • GitHub Actions • Infrastructure as Code',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Infra Synthesis. Built with Docusaurus & ❤️`,
      },
      prism: {
